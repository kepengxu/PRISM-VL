...
<p align="center">
  ...
  <a href="https://huggingface.co/kepeng/PRSIMVL-LoRA-V1">权重</a> ·
...
| 模型 | Qwen3-VL 2B、4B、8B，对应 PRSIMVL LoRA adapters，权重托管在 [Hugging Face](https://huggingface.co/kepeng/PRSIMVL-LoRA-V1)。 |
...
公开数据集位于 Hugging Face：[MeasL-Bench-V1](https://huggingface.co/datasets/kepeng/MeasL-Bench-V1) 用于评估，[MeasL-150K-V1](https://huggingface.co/datasets/kepeng/MeasL-150K-V1) 用于训练。Released LoRA 权重托管在 [kepeng/PRSIMVL-LoRA-V1](https://huggingface.co/kepeng/PRSIMVL-LoRA-V1)；完整 adapter 推理或评估前，需要将其恢复到 `exps/`。
...
| Released adapters | [`exps/`](exps/) 和 [HF](https://huggingface.co/kepeng/PRSIMVL-LoRA-V1) | Qwen3-VL 2B、4B、8B 的 LoRA checkpoints。 |
...
PRSIMVL LoRA 权重托管在 Hugging Face：[kepeng/PRSIMVL-LoRA-V1](https://huggingface.co/kepeng/PRSIMVL-LoRA-V1)。本地 release 默认在 `exps/BANALCED_150K_META_VIT_PROXY/` 下使用同样的 checkpoint 结构。
