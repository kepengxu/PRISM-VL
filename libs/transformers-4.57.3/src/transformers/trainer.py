            ...
            for _ in range(total_updates):
                ...
                for i, inputs in enumerate(batch_samples):
                    ...
                    with context():
                        ...
                        # 在 trainer.py 的 training_step 中
                        # if 'image_grid_thw' in inputs:
                        #     print(f'KPLOG image_grid_thw: {inputs["image_grid_thw"]}')
                        #     # 验证patches数
                        #     total_patches = sum(t * h * w for t, h, w in inputs["image_grid_thw"])
                        #     print(f'KPLOG total patches: {total_patches}, pixel_values[0]: {inputs["pixel_values"].shape[0]}')
                    if (
