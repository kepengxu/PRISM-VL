...
class SwiftSft(SwiftPipeline, TunerMixin):
    ...
    def _prepare_template(self) -> None:
        ...
        logger.info(f'Using template: {template.__class__.__name__}, processor: {self.processor.__class__.__name__}')
    ...
    def _get_dataset(self):
        ...
        logger.info(f'Dataset loaded. train={type(train_dataset).__name__}, val={type(val_dataset).__name__}')
    ...
    def _post_process_datasets(self, datasets: List) -> List:
        ...
        for i, dataset in enumerate(datasets):
            ...
            if i == 1 and predict_with_generate:
                ...
                continue
            # import swift
            # swift.llm.template.qwen.Qwen3VLTemplate
    ...
    def run(self):
        ...
        # import swift
        # swift.trainers.trainers.Seq2SeqTrainer
