...
class ModelArguments:
    ...
    camera_metadata_residual_enabled: bool = False
    camera_metadata_residual_num_layers: int = 2
    camera_metadata_require_all: bool = False
    camera_metadata_norm_scheme: Optional[str] = None
    ...
    def get_model_kwargs(self):
        ...
        use_camera_metadata_kwargs = (
            self.camera_metadata_residual_enabled
            or self.camera_metadata_residual_num_layers != 2
            or self.camera_metadata_require_all
            or self.camera_metadata_norm_scheme is not None
        )
        if use_camera_metadata_kwargs:
            model_kwargs.update({
                'camera_metadata_residual_enabled': self.camera_metadata_residual_enabled,
                'camera_metadata_residual_num_layers': self.camera_metadata_residual_num_layers,
                'camera_metadata_require_all': self.camera_metadata_require_all,
                'camera_metadata_norm_scheme': self.camera_metadata_norm_scheme or 'photographic_log',
            })
        return {
