...
from swift.llm.data_loader import ImageSizeBucketSampler
        ...
        if dataloader is None:
            ...
            if hasattr(train_dataset, '__len__'):
                if args.group_by_size:
                    # batch_sampler_params['group_by_size'] = args.group_by_size
                    batch_sampler_params['image_sizes'] = train_dataset.image_sizes
                ...
                batch_sampler = ImageSizeBucketSampler(
                    len(train_dataset), batch_size=self._train_batch_size, **batch_sampler_params)
                dataloader_params['worker_init_fn'] = partial(
